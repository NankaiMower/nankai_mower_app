...
*/
    ...
    if (!centerOnRobot) {
      mapScale =
          min(drawingRect.width / mapWidth, drawingRect.height / mapHeight);
    }
    ...
    */
    ...
    if (!centerOnRobot) {
      ...
      canvas.translate(
          mapWidth / 2 - mapModel.centerX, mapHeight / 2 - mapModel.centerY);
    } else {
      // center on robot
      canvas.translate(
          mapWidth / 2 - robotState.posX, mapHeight / 2 - robotState.posY);
